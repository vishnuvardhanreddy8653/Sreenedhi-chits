  ...
  return (
    <div className="bg-white py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-extrabold mb-6">Frequently asked Questions (FAQs)</h1>

        <div className="prose max-w-none text-gray-800">
          <p>Welcome to Srinidhi Chitfunds(Hyderabad) pvt. ltd..</p>

          <p>We understand that privacy online is important to users of our Site, especially when conducting business.
          This statement governs our privacy policies with respect to those users of the Site (“Visitors”) who visit without transacting business and Visitors who register to transact business on the Site and make use of the various services offered by Dartmouth Casual Furniture, Inc. (collectively, “Services”) (“Authorized Customers”).</p>
          ...
          <p>Personally Identifiable Information collected by Dartmouth Casual Furniture, Inc. is securely stored and is not accessible to third parties or employees of Dartmouth Casual Furniture, Inc. except for use as indicated above.</p>

          <h3>What choices are available to Visitors regarding collection, use and distribution of the information?</h3>
          <p>Visitors and Authorized Customers may opt out of receiving unsolicited information from or being contacted by us and/or our vendors and affiliated agencies by responding to emails as instructed, or by contacting us at dartmouthcasual@gmail.com</p>
          ...
          <h3>How does Dartmouth Casual Furniture, Inc. use login information?</h3>
          <p>Dartmouth Casual Furniture, Inc. uses login information, including, but not limited to, IP addresses, ISPs, and browser types, to analyze trends, administer the Site, track a user’s movement and use, and gather broad demographic information.</p>

          <h3>What partners or service providers have access to Personally Identifiable Information?</h3>
          <p>Dartmouth Casual Furniture, Inc. has entered into and will continue to enter into partnerships and other affiliations with a number of vendors. Such vendors may have access to certain Personally Identifiable Information on a need to know basis for evaluating Authorized Customers for service eligibility. Our privacy policy does not cover their collection or use of this information. Disclosure of Personally Identifiable Information to comply with law. We will disclose Personally Identifiable Information in order to comply with a court order or subpoena or a request from a law enforcement agency to release information. We will also disclose Personally Identifiable Information when reasonably necessary to protect the safety of our Visitors and Authorized Customers.</p>
          ...
          <p>Visitors and Authorized Customers may contact us to update Personally Identifiable Information about them or to correct any inaccuracies by emailing us at 709 Dartmouth Street, Dartmouth, MA 02748</p>

          <h3>Can a Visitor delete or deactivate Personally Identifiable Information?</h3>
          ...
          <h3>Links:</h3>
          <p>DartmouthCasualFurniture.com contains links to other web sites. Please note that when you click on one of these links, you are moving to another web site. We encourage you to read the privacy statements of these linked sites as their privacy policies may differ from ours.</p>
        </div>
      </div>
    </div>
  );
